return {
    "jghauser/mkdir.nvim", -- create missing directories on write
    {
        ...
        config = function()
            ...
            vim.keymap.set("n", "<leader>tr", ":Neotree refresh<CR>")
            vim.keymap.set("n", "<leader>tn", ":Neotree find<CR>")
            ...
            require("neo-tree").setup({
                ...
                filesystem = {
                    ...
                    window = {
                        mappings = {
                            ...
                            ["[g"] = "prev_git_modified",
                            ["]g"] = "next_git_modified",
                            ["o"] = { "show_help", nowait = false, config = { title = "Order by", prefix_key = "o", position = "bottomright" } },
                ...
                git_status = {
                    window = {
                        ...
                        mappings = {
                            ["A"] = "git_add_all",
                            ["g"] = { "show_help", nowait = false, config = { title = "Git Status", prefix_key = "g", position = "bottom" } },
                            ["gu"] = "git_unstage_file",
                            ["ga"] = "git_add_file",
                            ["gr"] = "git_revert_file",
                            ["gc"] = "git_commit",
